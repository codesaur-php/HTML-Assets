    ...
    $.fn.Plupload = function(options, callback) {
        ...
        settings.init = {
            ...
            FileUploaded: function(up, file, response) {
                ...
                try {
                    ...
                    if (callback && typeof callback === "function") {
                        ...
                        $(this).notifyMe('top', 'success', settings.texts.success, 'Your file [' + file.name + '] was uploaded successfully.', 200, 3000);
                    }
                }
                catch (err) {
                    ...
                    $(this).notifyMe('top', 'error', settings.texts.failure, err, 200, 3000);
                }
            ...
            Error: function(up, err) {
                ...
                $(this).notifyMe('top', 'error', settings.texts.warning, err.message, 200, 3000);
            }
        };
